...
- **Django REST Framework 3.12.4** — создание API
- **Djoser 2.1** — аутентификация и регистрация
...
# Терминал 2 - Kittygram (порт 8000)
